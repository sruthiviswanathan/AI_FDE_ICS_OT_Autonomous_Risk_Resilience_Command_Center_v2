...
Full acceptance set: `specs/APP_ACCEPTANCE_TESTS.md` (APP-AT-001…024); index in `specs/REQUIREMENTS_TRACEABILITY.md`.
...
**Next:** APP-01 (API/OpenAPI completeness), APP-02 (operator UI + UI verification against APP_ACCEPTANCE_TESTS.md).
