...
- Engines in `ot_command.core`: identity, telemetry, risk, containment, recovery, authority, agent. Isolation is never execute. CURRENT backup is not RecoveryReady. POST /recommend is a packet, not an OT action.
